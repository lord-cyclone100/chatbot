...
# def chat():
#     global current_question_index, user_inputs
...
#         # Assuming that the inputs are in the order: [temperature, humidity, moisture, nitrogen, phosphorus, potassium, soil type, crop type]
#         # Here, you might need to encode the soil type and crop type if they are categorical variables
...
#         return render_template('index.html', answer=f"The suitable fertilizer is: {le.inverse_transform(prediction)}", question=None)
    
#     # Otherwise, continue asking questions
#     next_question = questions[current_question_index]
#     return render_template('index.html', question=next_question)
